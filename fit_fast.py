...
def main():
    ...
    bounds = [
        (-2.0, 0.0), (-0.5, 0.5), (0.0, 2.0),
        (0.0001, 0.05), (0.0001, 0.05), (0.0001, 0.05),
        (0.0, 15.0), (0.0, 25.0), (0.0, 40.0),
        (-0.05, 0.05),
        (1.0, 2.0)
    ]

    print("Starting FAST DE solver...")
    res = differential_evolution(loss, bounds, maxiter=500, workers=1, popsize=10, disp=True)
