...
# Anchor S_base to 0. 
# Allow other parameters to float. Age*lap could be negative (fuel lessens degradation)
bounds = [(0, 0)] + [(None, None)] * 11

res = minimize(loss, np.zeros(12), method='L-BFGS-B', bounds=bounds)

print(f"Fuel Interaction Loss: {res.fun:.4f}")
